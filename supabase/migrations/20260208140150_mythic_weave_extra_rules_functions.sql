-- Mythic Weave Core: additional rules enforcement + append-only logs + helper views/functions
...
-- These are *filters* (best-effort); the canonical generator script MUST also enforce policy.
-- -----------------------------
...
-- Item stat_mods JSON contract (numbers only, additive):
-- {
--   "offense": 3,
--   "defense": 2,
--   "control": 0,
