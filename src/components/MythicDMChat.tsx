...
export function MythicDMChat({
  ...
  useEffect(() => {
    ...
    setHasUnread(true);
  }, [currentResponse, isLoading, isNearBottom, jumpToLatest, messages, resolveViewport]);
      ...
      <div className="border-t border-border p-3">
        ...
        {typeof voiceEnabled === "boolean" ? (
          <div className="mb-2 flex flex-wrap items-center gap-2 text-xs">
            ...
            {voiceBlocked ? (
              <span className="text-amber-300">Playback blocked. Use Speak Latest to resume.</span>
            ) : null}
          </div>
        ) : null}
