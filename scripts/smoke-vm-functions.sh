...
BASE="${VITE_MYTHIC_FUNCTIONS_BASE_URL:-${VITE_TAILSCALE_FUNCTIONS_BASE_URL:-${MYTHIC_FUNCTIONS_BASE_URL:-}}}"
...
if [[ -z "${BASE}" ]]; then
  echo "Missing VITE_MYTHIC_FUNCTIONS_BASE_URL, VITE_TAILSCALE_FUNCTIONS_BASE_URL, or MYTHIC_FUNCTIONS_BASE_URL."
  exit 1
fi
